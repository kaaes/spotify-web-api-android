package io.github.kaaes.spotify.webapi;
...
import io.github.kaaes.spotify.webapi.retrofit.v1.SpotifyError;
import io.github.kaaes.spotify.webapi.retrofit.v1.SpotifyService;
...
public class SpotifyServiceTest {
    ...
    public void shouldGetNewReleases() throws IOException {
        ...
        options.put(Options.COUNTRY, countryId);
        options.put(Options.OFFSET, 0);
    ...
    public void shouldGetFeaturedPlaylists() throws IOException {
        ...
        map.put(Options.COUNTRY, countryId);
        map.put(Options.LOCALE, locale);
        map.put(Options.OFFSET, 0);
        map.put(Options.LIMIT, limit);
